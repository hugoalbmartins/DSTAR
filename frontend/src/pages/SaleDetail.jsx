    ...
    <div className="max-w-4xl mx-auto space-y-6" data-testid="sale-detail-page">
      ...
      <div className="flex items-center justify-between">
        ...
        <Link to={`/sales/${id}/edit`}>
          <Button className="btn-primary btn-primary-glow flex items-center gap-2" data-testid="edit-sale-btn">
            <Edit2 size={16} />
            Editar
          </Button>
        </Link>
        ...
        <CardContent className="pt-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div>
              ...
              <p className="text-white">{sale.partner}</p>
            </div>
            <div>
            ...
            <div>
              <p className="text-white/50 text-sm mb-1 flex items-center gap-1">
                <Calendar size={14} /> Data de Ativação
              </p>
