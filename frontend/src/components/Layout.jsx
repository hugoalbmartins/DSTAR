    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50/30">
      ...
      <main className="min-h-screen w-full">
        <div className="min-h-screen lg:ml-64">
          {/* Top bar */}
          <div className="sticky top-0 z-30 bg-white/80 backdrop-blur-xl border-b border-slate-200/60 px-4 lg:px-6 py-5 flex items-center justify-center shadow-sm relative">
